---
title: "demonetization (Current) Sentiment Analysis"
output:
...
dataframe=read.csv('D:/personal/ISB/pgdba/CBA/offer/CBA/Course/term 1/Practicum/current df/demonetization_df_1.csv', stringsAsFactors = F)
df=dataframe$text
#colnames(df) <- 'text'
...
comn  = unique(c(stpw1, stpw2,'demonetization','demonetisation','ji','india','indian','sir','modi'))         # Union of the two lists
...
scale = c(3, 0.2),     # range of word sizes
