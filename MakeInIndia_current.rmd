---
title: "MakeInIndia (Current) Sentiment Analysis"
output:
...
dataframe=read.csv('D:/personal/ISB/pgdba/CBA/offer/CBA/Course/term 1/Practicum/current df/MakeInIndia_df_1.csv', stringsAsFactors = F)
df=dataframe$text
#colnames(df) <- 'text'
...
comn  = unique(c(stpw1, stpw2,'makeinindia','ji','india','indian'))         # Union of the two lists
